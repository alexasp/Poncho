...
namespace Poncho.ViewModels
{
    ...
    public class ShellViewModel : PropertyChangedBase, IShellViewModel
    {
        ...
        public ShellViewModel(ITrackHandler trackHandler, ISearchManager searchManager, IPlaylistManager playListManager, IUserFeedbackHandler userFeedbackHandler)
        {
